...
+ 1 [Anomaly detection](ex08.md#1-anomaly-detection)
    + 1.1 [Gaussian distribution](ex08.md#1-1-gaussian-distribution)
    + 1.2 [Estimating parameters for a Gaussian](ex08.md#1-2-estimating-parameters-for-a-gaussian)
    + 1.3 [Selecting the threshold, $\epsilon$](ex08.md#1-3-selecting-the-threshold-1963-)
    + 1.4 [High dimensional dataset](ex08.md#1-4-high-dimensional-dataset)
+ 2 [Recommender Systems](ex08.md#2-recommender-systems)
    + 2.1 [Movie ratings dataset](ex08.md#2-1-movie-ratings-dataset)
    + 2.2 [Collaborative filtering learning algorithm](ex08.md#2-2-collaborative-filtering-learning-algorithm)
        + 2.2.1 [Collaborative filtering cost function](ex08.md#2-2-1-collaborative-filtering-cost-function)
        + 2.2.2 [Collaborative filtering gradient](ex08.md#2-2-2-collaborative-filtering-gradient)
        + 2.2.3 [Regularized cost function](ex08.md#2-2-3-regularized-cost-function)
        + 2.2.4 [Regularized gradient](ex08.md#2-2-4-regularized-gradient)
    + 2.3 [Learning movie recommendations](ex08.md#2-3-learning-movie-recommendations)
        + 2.3.1 [Recommendations](ex08.md#2-3-1-recommendations)
+ [Vectorized Collaborative Filtering Cost Function & Gradients](ex08.md#vectorized-collaborative-filtering-cost-function-gradients)
    + [Notations](ex08.md#notations)
    + [Cost Function](ex08.md#cost-function)
    + [Gradients](ex08.md#gradient)
+ [Programming Exercise Tutorial](ex08.md#programming-discussion)
    + [Error in `ex8_cofi.m`](ex08.md#)
    + [ex8 tutorial for `cofiCostFunc()`](ex08.md#ex8-tutorial-for-coficostfunc-)
    + [Programming Exercise 8](ex08.md#programming-exercise-8)
    + [FAQ for Week 9 and programming exercise 8](ex08.md#faq-for-week-9-and-programming-exercise-8)
    + [Test cases for ex8_cofi - Recommender Systems](ex08.md#test-cases-for-ex8_cofi-recommender-systems)
    + [Vectorized Implementation of Computing Gradient](ex08.md#vectorized-implementation-of-computing-gradient)
    + [Computing gradient can be fully vectorized](ex08.md#computing-gradient-can-be-fully-vectorized)
