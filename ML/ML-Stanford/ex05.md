...
Q1) For `learningCurve()` and `validationCurve()`, why don't we include regularization when computing $J_{train}$, $J_{cv}$, and $J_{test}$?
...
Q3) How do I compute $J_{test}$ for the optional Section 3.4?
...
Q7) My "Fig. 4" doesn't look like the one in ex5.pdf. Is that a problem?
...
Q9) How do I get started on random learning curve (optional section 3.5)?
...
Q10) What are the correct results for the learningCurve() test in ex5.m "Part 5 - linear regression" with lambda = 0?
...
Q11) What are the correct results for the learningCurve() test in ex5.m "Part 7 - polynomial regression" with lambda = 0?
...
Q12) I got the correct values shown in FAQ Q10 and Q11. Why does "submit" fail?

    The grader uses a nonzero lambda. Use the Test Cases.


Q14) Some of my values from Q10 and Q11 are not exactly correct, but the grader says my code is correct. Why?
...
Q15) Why does overfitting make the validation set cost increase?
...
Q16) In Optional section 3.5, why don't we use the entire validation set every time?
