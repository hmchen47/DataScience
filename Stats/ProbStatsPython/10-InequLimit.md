...
+ Convergence
  ...
  + cumulative distribution function (CDF):
    ...
    \[\begin{align*}
      ...
      F_{Z}(x) &= \int_{-\infty}^x \frac{1}{\sqrt{2\pi}} e^{-\frac{t^2}{2}} dt \stackrel{\text{def}}{=} \Phi(x) \left(Z \sim N(0, 1) \right)
    \end{align*}\]
...
+ Proof
  ...
  + prove: $M_{Z_n}(t) \xrightarrow[n \to \infty]{} e^{\frac{t^2}{2}} \implies F_{Z_n}(t) \xrightarrow[n \to \infty]{} \Phi(t)$
    ...
    \[\begin{align*}
      Z_n &= \frac{1}{\sqrt{n}} \sum_{i=1}^n X_i = \sum_{i=1}^n \frac{X_1}{\sqrt{n}} \to M_{\frac{X_i}{\sqrt{n}}} &= M_{X_i} \left( \frac{t}{\sqrt{n}} \right) = M\left( \frac{t}{\sqrt{n}} \right) \\\\
...
+ Assembling
  ...
  + $\lim_{n \to \infty} M_{Z_n}(t) = \lim_{n \to \infty} \left[ M\left( \frac{t}{\sqrt{n}} \right) \right]^n = e^{\frac{t^2}{2}} = M_Z(t)$
    + $F_{Z_n} \to F_Z = \Phi$
