...
+ [Naive Bayes Classifiers](./04-Supervised2.md$)
+ [Random Forests](./04-Supervised2.md$)
+ [Gradient Boosted Decision Trees](./04-Supervised2.md$)
+ [Neural Networks](./04-Supervised2.md$)
+ [Neural Networks Made Easy (optional)](./04-Supervised2.md$)
+ [Play with Neural Networks: TensorFlow Playground (optional)](./04-Supervised2.md$)
+ [Deep Learning (Optional)](./04-Supervised2.md$)
+ [Deep Learning in a Nutshell: Core Concepts (optional)](./04-Supervised2.md$)
+ [Assisting Pathologists in Detecting Cancer with Deep Learning (optional)](./04-Supervised2.md$)
+ [Data Leakage](./04-Supervised2.md$)
